    ...
    return(
        <div className="features container d-flex flex-column justify-contant-centre align-items-center">
            ...
            <div className="featuresMainBox d-flex flex-wrap justify-content-between align-items-center">
                ...
                <FeaturesBox logo={<i className="bi bi-camera-reels-fill"></i>} heading="Latest Security" L1="Single sign-on" L2="Encrypted sessions" L3="Meeting lock" L4="Dismiss attendees" L5="COMING SOON: End-to-end encryption" L6=""/>
